--------------------------------------------------------------------------------
-- File    : fir_parallel.vhd  (LAB 4 - reuses the LAB 2 pipeline ON PURPOSE)
--           Lab 4 changes NOTHING in this RTL. It is the same hand-placed,
--           not-yet-balanced pipeline from Lab 2 - precisely so the TOOL FLOW
--           (retiming / phys_opt / strategies) has something to optimize. The
--           point of Lab 4 is "same source, different tool settings".
--
-- (original Lab 2 header follows)
